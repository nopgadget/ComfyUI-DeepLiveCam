...
def parse_args() -> None:
    ...
    globals.keep_audio = args.keep_audio
    globals.keep_frames = args.keep_frames
    globals.many_faces = args.many_faces
    globals.mouth_mask = args.mouth_mask
    globals.nsfw_filter = args.nsfw_filter
    globals.map_faces = args.map_faces
    globals.video_encoder = args.video_encoder
    globals.video_quality = args.video_quality
    globals.live_mirror = args.live_mirror
    globals.live_resizable = args.live_resizable
    ...
    if 'face_enhancer' in args.frame_processor:
        ...
        globals.fp_ui['face_enhancer'] = False

    # translate deprecated args
    if args.source_path_deprecated:
        print('\033[33mArgument -f and --face are deprecated. Use -s and --source instead.\033[0m')
        globals.source_path = args.source_path_deprecated
        globals.output_path = normalize_output_path(args.source_path_deprecated, globals.target_path, args.output_path)
    if args.cpu_cores_deprecated:
        print('\033[33mArgument --cpu-cores is deprecated. Use --execution-threads instead.\033[0m')
        globals.execution_threads = args.cpu_cores_deprecated
    if args.gpu_vendor_deprecated == 'apple':
        print('\033[33mArgument --gpu-vendor apple is deprecated. Use --execution-provider coreml instead.\033[0m')
        globals.execution_providers = decode_execution_providers(['coreml'])
    if args.gpu_vendor_deprecated == 'nvidia':
        print('\033[33mArgument --gpu-vendor nvidia is deprecated. Use --execution-provider cuda instead.\033[0m')
        globals.execution_providers = decode_execution_providers(['cuda'])
    if args.gpu_vendor_deprecated == 'amd':
        print('\033[33mArgument --gpu-vendor amd is deprecated. Use --execution-provider cuda instead.\033[0m')
        globals.execution_providers = decode_execution_providers(['rocm'])
    if args.gpu_threads_deprecated:
        print('\033[33mArgument --gpu-threads is deprecated. Use --execution-threads instead.\033[0m')
        globals.execution_threads = args.gpu_threads_deprecated
...
def start() -> None:
    ...
    if has_image_extension(globals.target_path):
        if globals.nsfw_filter and ui.check_and_ignore_nsfw(globals.target_path, destroy):
            return
        try:
...
def run() -> None:
    ...
    if globals.headless:
        ...
        window = ui.init(start, destroy, globals.lang)
        window.mainloop()
